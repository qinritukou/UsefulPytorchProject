...
def imshow(inp, title=None):
    ...
    inp = std * inp + mean 
    inp = np.clip(inp, 0, 1) # limit from 0 to 1 
    plt.imshow(inp)
...
# # Train and evaluate 
# model_ft = train_model(model_ft, crierion, optimizer_ft, exp_lr_scheduler, num_epochs=25)
...
# Parameters of newly constructed modules have requires_grad=True by defalt
